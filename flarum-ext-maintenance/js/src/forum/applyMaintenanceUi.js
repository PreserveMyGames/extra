...
function mode() {
  return app.forum.attribute('preservemygamesMaintenanceMode') || 'off';
}
...
function shouldShowBanner() {
  ...
  return !!app.forum.attribute('preservemygamesMaintenanceShowBanner');
}
...
function allowLoginUi() {
  ...
  if (mode() === 'closed') {
    return !!app.forum.attribute('preservemygamesMaintenanceAllowLogin');
  }
...
function showMaintenanceAlert() {
  app.alerts.show(
    { type: 'error' },
    app.forum.attribute('preservemygamesMaintenanceMessage')
  );
}
