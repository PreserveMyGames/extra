...
namespace PreserveMyGames\Lxmf\Listener;
...
use PreserveMyGames\Lxmf\LxmfAddress;
    ...
    public function handle(Saving $event): void
    {
        ...
        if (! LxmfAddress::isValid($normalized)) {
            throw new ValidationException([
                'lxmfAddress' => [$this->translator->trans('preservemygames-lxmf.validation.invalid')],
            ]);
        }
        ...
        if ($taken) {
            throw new ValidationException([
                'lxmfAddress' => [$this->translator->trans('preservemygames-lxmf.validation.taken')],
            ]);
        }
