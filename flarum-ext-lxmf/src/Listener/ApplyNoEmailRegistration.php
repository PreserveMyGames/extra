...
class ApplyNoEmailRegistration
{
    ...
    public function handle(Saving $event): void
    {
        ...
        if (! (bool) $this->settings->get('preservemygames-lxmf.no_email_registration', '1')) {
            return;
        }
        ...
        $domain = (string) $this->settings->get('preservemygames-lxmf.email_domain', 'noreply.invalid');
