...
|---------|--------|--------------|-------|
| Flarum | `flarum/` | `ravenguard:8080` (forum), `ravenguard-hub:8080` (WAF admin) | `ghcr.io/preservemygames/extra/flarum` + `.../ravenguard` |
...
Rootless forum image with bundled PreserveMyGames extensions. Coolify traffic goes through [RavenGuard](https://github.com/Quad4-Software/ravenguard) in [fleet mode](https://ravenguard.quad4.io/docs/intro) (WAF edge + separate hub):
