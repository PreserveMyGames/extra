...
function t(key, params = {}) {
  return app.translator.trans(`preservemygames-spam-protection.admin.${key}`, params);
}
...
app.initializers.add('preservemygames-spam-protection', () => {
  ...
  ext
    .registerSetting(
      {
        setting: 'preservemygames-spam-protection.enabled',
        type: 'boolean',
    ...
    .registerSetting(
      {
        setting: 'preservemygames-spam-protection.api_key',
        type: 'password',
    ...
    .registerSetting(
      {
        setting: 'preservemygames-spam-protection.base_url',
        type: 'text',
    ...
    .registerSetting(
      {
        setting: 'preservemygames-spam-protection.model',
        type: 'text',
    ...
    .registerSetting(
      {
        setting: 'preservemygames-spam-protection.monitor_posts',
        type: 'boolean',
    ...
    .registerSetting(
      {
        setting: 'preservemygames-spam-protection.monitor_edits',
        type: 'boolean',
    ...
    .registerSetting(
      {
        setting: 'preservemygames-spam-protection.monitor_new_users',
        type: 'boolean',
    ...
    .registerSetting(
      {
        setting: 'preservemygames-spam-protection.min_confidence',
        type: 'number',
    ...
    .registerSetting(
      {
        setting: 'preservemygames-spam-protection.action_hide_post',
        type: 'boolean',
    ...
    .registerSetting(
      {
        setting: 'preservemygames-spam-protection.action_hide_discussion',
        type: 'boolean',
    ...
    .registerSetting(
      {
        setting: 'preservemygames-spam-protection.action_lock_discussion',
        type: 'boolean',
    ...
    .registerSetting(
      {
        setting: 'preservemygames-spam-protection.action_suspend_user',
        type: 'boolean',
    ...
    .registerSetting(
      {
        setting: 'preservemygames-spam-protection.suspend_days',
        type: 'number',
    ...
    .registerSetting(
      {
        setting: 'preservemygames-spam-protection.fail_open',
        type: 'boolean',
  ...
  extend(ExtensionPage.prototype, 'oninit', function () {
    if (this.extension.id !== 'preservemygames-spam-protection') {
      return;
    }
  ...
  ExtensionPage.prototype.pmgRescanRecent = async function () {
    if (this.extension.id !== 'preservemygames-spam-protection' || this.pmgSpamRescanning) {
      return;
    }
